...
/* something wrong if directly use cre2_easy_match*/
cre2_decl cre2_string_t * cre2_strings_duplicate(cre2_string_t * source, int size);
cre2_decl void cre2_strings_free(cre2_string_t *strings, int size);
...
cre2_decl int cre2_match_ex	(const cre2_regexp_t * re,
				 const char * text, int textlen,
				 int startpos, int endpos, cre2_anchor_t anchor,
